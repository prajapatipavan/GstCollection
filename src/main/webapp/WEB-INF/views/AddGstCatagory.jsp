...
<html lang="en">
  <head>
    ...
    <title>Create New GST Category</title>
            ...
            <div class="row justify-content-center">
              <div class="col-lg-6">
                <div class="form-container">
                  <h3 class="form-title">Create New GST Category</h3>
                  <form action="createGSTCategory" method="post">
                    <div class="form-group">
                      <label for="name">Category Name:</label>
                      <input type="text" class="form-control" id="name" name="catagoryName" placeholder="Enter category name" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group text-center">
                      <input type="submit" class="btn btn-primary" value="Create GST Category">
                    </div>
                  </form>
                </div>
              </div>
